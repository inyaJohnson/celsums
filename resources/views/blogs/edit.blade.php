...
@section('custom_content')
    ...
    <div class="subheader px-lg">
        <div class="subheader-container">
            ...
            <div class="subheader-toolbar"><a class="btn btn-opacity-primary btn-sm mr-2" href="{{route('admin.blogs.index')}}">Back</a>
            </div>
        </div>
    </div>
    ...
    <div class="container my-lg">
        ...
        <form id="faq-form" action="{{ route('blogs.update', $blog->id) }}" method="post">
            @method('PUT')
            @csrf
            <div class="doc-example">
                ...
                <textarea id="summernote" name="answer">{!! x !!}</textarea>
