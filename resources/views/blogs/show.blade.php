            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-lg-9">
                        ...
                        <h5 class="blog-post__title">Back to the future: Quality education through respect, commitment and
                            accountability</h5>
                        <p>Flyingfish Kafue pike cow shark California smoothtongue golden loach temperate ocean-bass gulper
                            eel. Sailbearer kanyu porcupinefish Kafue pike opah sunfish gudgeon boga Asiatic glassfish
                            tadpole fish! Alewife, poacher airbreathing catfish; zebra tilapia northern pearleye naked-back
                            knifefish pupfish dojo loach, "snake mackerel bonytail chub arapaima horsefish weasel shark."
                        </p>
                        <p>Asian carps sailback scorpionfish; dragon goby lemon sole triplefin blenny hog sucker. Smelt
                            sleeper shovelnose sturgeon merluccid hake cow shark herring smelt trout-perch barbeled
                            houndshark. Shell-ear Asian carps blackfish Port Jackson shark Atlantic saury. Sacramento
                            blackfish pricklefish, Atlantic cod, "driftwood catfish chimaera ribbonfish, marblefish worm eel
                            smelt mora gray reef shark scabbard fish."</p>
                        <p>Northern anchovy--bass yellowtail barracuda zander yellowfin grouper gurnard skipjack tuna shark
                            burrowing goby eulachon wobbegong. Nase combtail gourami amur pike flabby whalefish; darter,
                            Blind goby tuna. Eagle ray soapfish ocean sunfish filefish, barbel sandfish wolf-herring
                            northern pike roach sea snail barbelless catfish, Atlantic saury mackerel shark pike conger.
                            Blind shark longfin smelt pearl perch bent-tooth stargazer grunion spookfish yellowtail
                            Quillfish slickhead mora. Springfish snake mackerel sockeye salmon banjo catfish toadfish sauger
                            four-eyed fish </p>
                        <p class="text-filled">Streamer fish California halibut Pacific saury. Slickhead grunion lake
                            trout. Canthigaster rostrata spikefish brown trout loach summer flounder European minnow black
                            dragonfish orbicular batfish stingray tenpounder. Sucker lionfish garibaldi surgeonfish Celebes
                            rainbowfish forehead brooder</p>
                        <p>Flyingfish Kafue pike cow shark California smoothtongue golden loach temperate ocean-bass gulper
                            eel. Sailbearer kanyu porcupinefish Kafue pike opah sunfish gudgeon boga Asiatic glassfish
                            tadpole fish! Alewife, poacher airbreathing catfish; zebra tilapia northern pearleye naked-back
                            knifefish pupfish dojo loach, "snake mackerel bonytail chub arapaima horsefish weasel shark."
                        ...
                        <div class="blog-post__details">
                            <div class="row align-items-center">
                                <div class="col-lg-3 text-center text-lg-left"><span class="blog-post__name">Samuel
                                        Smith</span></div>
                    ...
                    <div class="col-md-4 col-lg-3">
                        ...
                        <div class="tags"><a class="tags__item" href="#">Charity</a><a
                                class="tags__item" href="#">Help</a><a class="tags__item" href="#">Freedom</a><a
                                class="tags__item" href="#">Fundraising</a><a class="tags__item"
                                href="#">Donate</a><a class="tags__item" href="#">Water</a></div>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="blog-item blog-item--style-1">
                            ...
                            <div class="blog-item__content">
                                <h6 class="blog-item__title"><a href="blog-post.html">Share HHAPI-NeSS this Mother’s Day
                                        support Save the Children</a></h6>
                        ...
                        <div class="blog-item blog-item--style-1">
                            ...
                            <div class="blog-item__content">
                                <h6 class="blog-item__title"><a href="blog-post.html">Save the Children's Role in Fight
                                        Against Malnutrition Hailed</a></h6>
                                <p>Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray Sacramento
                                    splittail canthigaster</p>
                                <div class="blog-item__details"><span class="blog-item__date">23 Jan' 19</span><span>
                                        <svg class="icon">
