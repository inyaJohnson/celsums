            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-xl-6 offset-xl-1">
                        <div class="heading heading--primary"><span class="heading__pre-title">Community a Officer – Mr
                                Charity</span>
                            ...
                            <p>Alienum phaedrum torquatos nec eu, vis detraxit periculis ex, nihil expetendis in mei. Mei an
                                ...
                                urbanitas moderatius id. Vis ei rationibus definiebas, eu qui purto zril laoreet. Ex error
                                omnium interpretaris pro, alia illum ea vim. Lorem ipsum dolor sit amet, eu per legimus
                                referrentur. Ius ne viris repudiare, nominavi sententiae eos in.</p>
                            <p>Alienum phaedrum torquatos nec eu, vis detraxit periculis ex, nihil expetendis in mei. Mei an
                                pericula euripidis, hinc partem ei est. Eos ei nisl graecis, vix aperiri consequat an. Eius
                                lorem tincidunt vix at, vel pertinax sensibus id, error epicurei mea et. Mea facilisis
                                urbanitas moderatius id. Vis ei rationibus definiebas.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="team-member__skills">
                            ...
                            <p class="margin-bottom">Alienum phaedrum torquatos nec eu, vis detraxit periculis ex, nihil
                                expetendis in mei. Mei an pericula euripidis, hinc partem ei est. Eos ei nisl graecis, vix
                                aperiri consequat an. Eius lorem tincidunt vix at, vel pertinax. Mei an pericula euripidis,
                                hinc partem ei est. , hinc partem ei est.</p>
                            <h6 class="team-member__subtitle">Leadership</h6>
                            <div class="progress-bar">
                                <div class="progress-bar__inner" style="width: 78%;">
                                    <div class="progress-bar__value">78%</div>
                                </div>
                            </div>
                            <h6 class="team-member__subtitle">Volunteering</h6>
                            <div class="progress-bar">
                                <div class="progress-bar__inner" style="width: 72%;">
                                    <div class="progress-bar__value">72%</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-6 offset-xl-1">
                        <div class="team-member__details">
                            ...
                            <div class="team-member__details-item"><span>Phone:</span><span><a href="tel:+100026655787">+
                                        1000 266 55787</a></span></div>
                            <div class="team-member__details-item"><span>Email:</span><span><a
                                        href="mailto:donate.d@charity.com">donate.d@charity.com</a></span></div>
                            <div class="team-member__details-item"><span>Birthday:</span><span>September 21, 1992</span>
                            </div>
                            <div class="team-member__details-item"><span>Location:</span><span>Nursultan</span></div>
                        ...
                        <div class="projects-masonry__img"><img class="img--bg" src="/template/assets/img/projects-slider_1.jpg"
                            ...
                            <div class="projects-masonry__inner"><span class="projects-masonry__badge"
                                ...
                                <div class="projects-masonry__details-holder">
                                    ...
                                    <div class="projects-masonry__details-item"><span>Date: </span><span>23 Jan'19</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="projects-slider__item">
                    <div class="projects-masonry__item projects-masonry__item--primary projects-masonry__item--height-2">
                        <div class="projects-masonry__img"><img class="img--bg" src="/template/assets/img/projects-slider_3.jpg"
                            ...
                            <div class="projects-masonry__inner"><span class="projects-masonry__badge"
                                    style="background: #F36F8F;">Medicine</span>
                                <h3 class="projects-masonry__title"> <a href="cause-details.html">He Needs Your
                                        Protection</a></h3>
                                <p>Sea snail bigeye zebra turkeyfish mola mola sunfish roach. Southern Dolly Varden,
                                    lightfish ray long-whiskered catfish; burbot dealfish</p>
                                <div class="projects-masonry__details-holder">
                                    <div class="projects-masonry__details-item"><span>Goal: </span><span>35 000$</span>
                                    </div>
                                    <div class="projects-masonry__details-item"><span>Date: </span><span>23 Jan'19</span>
                                    </div>
                                </div>
