...
<body>
            ...
            <div class="aside-dropdown__inner"><span class="aside-dropdown__close">
                ...
                <div class="aside-dropdown__item d-lg-none d-block">
                    <ul class="aside-menu">
                        ...
                        <li class="aside-menu__item aside-menu__item--has-child"><a class="aside-menu__link"
                                href="javascript:void(0);"><span>Causes</span></a>
                            <!-- sub menu start-->
                            <ul class="aside-menu__sub-list">
                                <li><a href="/template/assets/causes.html"><span>Causes 1</span></a></li>
                                <li><a href="/template/assets/causes_2.html"> <span>Causes 2</span></a></li>
                                <li><a href="/template/assets/causes_3.html"><span>Causes 3</span></a></li>
                                <li><a href="/template/assets/cause-details.html"><span>Cause Details</span></a></li>
                            </ul>
                            <!-- sub menu end-->
                        </li>
            ...
            <div class="container-fluid">
                <div class="row no-gutters justify-content-between">
                    <div class="col-auto d-flex align-items-center">
                        ...
                        <div class="header-logo"><a class="header-logo__link" href="/template/assets/index.html"><img
                                    class="header-logo__img logo--light" src="/template/assets/img/logo_white.png"
                                    alt="logo" /><img class="header-logo__img logo--dark"
                                    src="/template/assets/img/logo_dark.png" alt="logo" /></a></div>
                    </div>
                    <div class="col-auto">
                        <!-- main menu start-->
                        <nav>
                            <ul class="main-menu">
                                ...
                                <li class="main-menu__item main-menu__item--has-child"><a class="main-menu__link"
                                    ...
                                    <ul class="main-menu__sub-list">
                                        ...
                                        <li><a href="/template/assets/causes_2.html"> <span>Causes 2</span></a></li>
                                        <li><a href="/template/assets/causes_3.html"><span>Causes 3</span></a></li>
                                        <li><a href="/template/assets/cause-details.html"><span>Cause Details</span></a>
                                        </li>
                                    </ul>
                                    <!-- sub menu end-->
                                </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-logo"><a class="footer-logo__link" href="/template/assets/index.html"><img
                                    class="footer-logo__img" src="/template/assets/img/logo_white.png" alt="logo" /></a>
                        </div>
    ...
    <script src="/template/assets/js/libs.min.js"></script>
    <!-- scripts-->
