                ...
                <div class="row margin-bottom">
                    <div class="col-12">
                        <div class="heading heading--primary heading--center"><span class="heading__pre-title">Donors</span>
                            ...
                            <p>Tackling the necessity of safe water for all requires a cooperative and worldwide effort.
                                Many philanthropists have chosen to take action in support of safe water by donating in
                                support of One Drop's projects.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="donors-list">
                            ...
                            <li class="donors-list__item"><a class="donors-list__link" href="#">Fondation Daniel Lamarre</a>
                            </li>
                            <li class="donors-list__item"><a class="donors-list__link" href="#">Paul G. Desmarais</a></li>
                            <li class="donors-list__item"><a class="donors-list__link" href="#">The Estate of Michael
                                    Jackson</a></li>
                            ...
                            <li class="donors-list__item"><a class="donors-list__link" href="#">Global affairs Canada</a>
                            </li>
                            <li class="donors-list__item"><a class="donors-list__link" href="#">Richard MacDonald Studio</a>
                            </li>
                            ...
                            <div class="row margin-bottom">
                                <div class="col-12">
                                    <div class="heading heading--primary heading--center">
                                        <h2 class="heading__title no-margin-bottom"><span>Founding</span>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <p><strong>Thresher shark rudd African lungfish silverside, Red salmon rockfish grunion,
                                            garpike zebra danio king-of-the-salmon banjo catfish."</strong></p>
                                    <p>Sea chub demoiselle whalefish zebra lionfish mud cat pelican eel. Minnow snoek
                                        icefish velvet-belly shark, California halibut round stingray northern sea robin.
                                        Southern grayling trout-perch</p>
                                    <p>Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray
                                        ...
                                        yellowtail kingfish basslet. Buri chimaera triplespine northern sea robin zingel
                                        lancetfish galjoen fish, catla wolffish, mosshead warbonnet </p>
                                </div>
                            </div>
                        </div>
                    </div>
