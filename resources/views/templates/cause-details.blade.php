...
@section('content')
    <main class="main">
        <section class="promo-primary">
            <picture>
                <source srcset="img/cause_details.jpg" media="(min-width: 992px)" /><img class="img--bg"
                    src="img/cause_details.jpg" alt="img" />
            </picture>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="donation-item">
                            <div class="donation-item__img"><img class="img--bg" src="img/donation-item_img.jpg"
                                    alt="img" /></div>
                            <div class="donation-item__body">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="donation-item__details-holder">
                                            <div class="donation-item__details-item"><span>Goal: </span><span>220
                                                    000$</span></div>
                                            <div class="donation-item__details-item"><span>Pledged: </span><span>95
                                                    200$</span></div>
                                        </div>
                                    </div>
                                </div>
                                <form class="form donation-form" action="javascript:void(0);">
                                    <div class="row align-items-baseline margin-bottom">
                                        ...
                                        <div class="col-lg-7 col-xl-6 text-lg-right">
                                            <label class="form__radio-label"><span class="form__label-text">$100.00</span>
                                                <input class="form__input-radio" type="radio" name="value-select"
                                            ...
                                            <label class="form__radio-label"><span class="form__label-text">$200.00</span>
                                                <input class="form__input-radio" type="radio" name="value-select"
                                                    value="200" /><span class="form__radio-mask form__radio-mask"></span>
                                            </label>
                                            <label class="form__radio-label"><span class="form__label-text">$500.00</span>
                                                <input class="form__input-radio" type="radio" name="value-select"
                                                    value="500" /><span class="form__radio-mask form__radio-mask"></span>
                                            </label>
                                            <label class="form__radio-label"><span class="form__label-text">$1000.00</span>
                                                <input class="form__input-radio" type="radio" name="value-select"
                                                    value="1000" /><span class="form__radio-mask form__radio-mask"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row margin-bottom">
                                        ...
                                        <div class="col-12">
                                            <label class="form__radio-label"><img class="form__label-img"
                                                    src="img/paypal.png" alt="paypal" />
                                                <input class="form__input-radio" type="radio" name="method-select"
                                            ...
                                            <label class="form__radio-label"><img class="form__label-img"
                                                ...
                                                <input class="form__input-radio" type="radio" name="method-select"
                                                    value="klarna" /><span class="form__radio-mask form__radio-mask"></span>
                                            </label>
                                            <label class="form__radio-label"><img class="form__label-img" src="img/visa.png"
                                                    alt="visa" />
                                                <input class="form__input-radio" type="radio" name="method-select"
                                                    value="visa" /><span class="form__radio-mask form__radio-mask"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="horizontal-tabs__content">
                                <div class="horizontal-tabs__item" id="horizontal-tabs__item-1">
                                    <p><strong>Thresher shark rudd African lungfish silverside, Red salmon rockfish grunion,
                                            garpike zebra danio king-of-the-salmon banjo catfish. Sea chub demoiselle
                                            whalefish zebra lionfish mud cat pelican eel.</strong></p>
                                    <p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern
                                        sea robin. Southern grayling trout-perch. Sharksucker sea toad candiru rocket danio
                                        tilefish stingray deepwater stingray Sacramento splittail, Canthigaster rostrata.
                                        Midshipman dartfish Modoc sucker, yellowtail kingfish basslet. Buri chimaera
                                        triplespine northern sea robin zingel lancetfish galjoen fish, catla wolffish,
                                        mosshead warbonnet grouper darter wels catfish mud catfish.</p>
                                    <p>African lungfish silverside, Red salmon rockfish grunion, garpike zebra danio
                                        king-of-the-salmon banjo catfish. Sea chub demoiselle whalefish zebra lionfish mud
                                        cat pelican eel. Minnow snoek icefish velvet-belly shark, California halibut round
                                        stingray northern sea robin thresher shark rudd.</p>
                                    <h6 class="tabs__title">Access</h6>
                                    <p>The aim is to promote the development of high-quality drinking water and sanitation
                                        services, accessible to everyone in the Sheohar District, and sustained by local
                                        communities, businesses, and governments.</p>
                                    <h6 class="tabs__title">Behaviour change</h6>
                                    <p>This project uses SABC interventions to engage Sheohar communities with respect to
                                        embracing healthy behaviours around water, sanitation, and hygiene — behaviours such
                                        as handwashing with soap at key moments, using household latrines, and the safe
                                        storage and handling of water.</p>
                                    <h6 class="tabs__title">Capital</h6>
                                    <p>In a region where the majority of the population consists of subsistence farmers,
                                        access to capital and the development of markets systems is crucial. In response to
                                        this, the Sheohar 2 project’s C component focuses specifically on people’s
                                        livelihoods, access to credit, and the provision of WASH-related products and
                                        services.</p>
                                </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-7">
                                                        <div class="donor-item__info">
                                                            <div class="donor-item__img"><img class="img--bg"
                                                                    src="img/face_1.jpg" alt="face" /></div>
                                            ...
                                            <div class="donor-item">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-7">
                                                        <div class="donor-item__info">
                                                            <div class="donor-item__img"><img class="img--bg"
                                                                    src="img/face_2.jpg" alt="face" /></div>
                                                            <div class="donor-item__description">
                                            ...
                                            <div class="donor-item">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-7">
                                                        <div class="donor-item__info">
                                                            <div class="donor-item__img"><img class="img--bg"
                                                                    src="img/face_3.jpg" alt="face" /></div>
                                                            <div class="donor-item__description">
                                            ...
                                            <div class="donor-item">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-7">
                                                        <div class="donor-item__info">
                                                            <div class="donor-item__img"><img class="img--bg"
                                                                    src="img/face_4.jpg" alt="face" /></div>
                                                            <div class="donor-item__description">
                                            ...
                                            <div class="donor-item">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-7">
                                                        <div class="donor-item__info">
                                                            <div class="donor-item__img"><img class="img--bg"
                                                                    src="img/face_5.jpg" alt="face" /></div>
                                                            <div class="donor-item__description">
                                            ...
                                            <div class="donor-item">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-7">
                                                        <div class="donor-item__info">
                                                            <div class="donor-item__img"><img class="img--bg"
                                                                    src="img/face_6.jpg" alt="face" /></div>
                                                            <div class="donor-item__description">
                                ...
                                <div class="horizontal-tabs__item" id="horizontal-tabs__item-3">
                                    <div class="video-frame"><img class="img--bg" src="img/video_frame-2.jpg"
                                            alt="frame" /><a class="video-trigger video-frame__trigger"
                                            href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"><span
                                                class="video-frame__icon"><i class="fa fa-play"
                                                    aria-hidden="true"></i></span><span class="video-frame__text">Watch our
                                                video</span></a></div>
                                </div>
                                <div class="horizontal-tabs__item" id="horizontal-tabs__item-4">
                                    <div class="gallery-simple">
                                        <div class="row offset-30">
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_1.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_1.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_2.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_2.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_3.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_3.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_4.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_4.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_5.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_5.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_6.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_6.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_7.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_7.jpg" alt="img" /></a></div>
                                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item"
                                                    href="img/ig_8.jpg" data-fancybox="simple-gallery"><img
                                                        class="img--bg" src="img/ig_8.jpg" alt="img" /></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- causes start-->
        <section class="section causes causes--style-2"><img class="causes__bg" src="img/causes_img-2.png"
                alt="img" />
            <div class="container">
                <div class="row align-items-end margin-bottom">
                    <div class="col-md-6 col-xl-5">
                        <div class="heading heading--primary no-margin-bottom"><span class="heading__pre-title">What we
                                Do</span>
                            ...
                            <div class="causes-item causes-item--primary">
                                <div class="causes-item__body">
                                    ...
                                    <div class="causes-item__img">
                                        ...
                                        </div><img class="img--bg" src="img/causes_1.jpg" alt="img" />
                                    </div>
                                ...
                                <div class="causes-item__body">
                                    ...
                                    <div class="causes-item__img">
                                        <div class="causes-item__badge" style="background-color: #F8AC3A">Food</div><img
                                            class="img--bg" src="img/causes_4.jpg" alt="img" />
                                    </div>
                                    <div class="causes-item__lower">
                                        <div class="progress-bar">
