                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-xl-6 offset-xl-1">
                        ...
                        <p>Burma danio black bass straptail southern Dolly Varden orbicular velvetfish trumpetfish;
                            ...
                            graveldiver river shark tripod fish; flagtail bala shark warbonnet.</p>
        ...
        <section class="section forms-section no-padding-top no-padding-bottom">
            <div class="container">
                <div class="row margin-bottom">
                    <div class="col-lg-6">
                        <div class="heading heading--primary"><span class="heading__pre-title">Fill Form and Beacame
                                Volonteer</span>
                        ...
                        <form class="form user-form" action="javascript:void(0);">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input class="form__field" type="number" name="date-of-birth"
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form__field form__message" name="message"
                                        placeholder="About Occupation"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
            ...
            </div><img class="forms-section__bg" src="/template/assets/img/volunteer-2.png" alt="img" />
        </section>
        <!-- section end-->
    </main>
@endsection
