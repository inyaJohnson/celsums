            ...
            <div class="col-lg-12">
                <div class="card overflow-hidden">
                    ...
                    <div class="py-md gray-200">
                        <div class="w-80 mx-auto">
                            <form id="deposit-form" action="{{route('stock_deposit.store', $stock['symbol'])}}" method="POST">
                                @csrf
                                <input class="form-control" style="border:solid thin" type="number" name="units" id="units" placeholder="Enter Units"/>
                                <input type="hidden" name="price"  value="{{$stock['regularMarketPrice']}}"/>
                            </form>
                            <div class="table-responsive mb-xxxl">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td class="font-weight-bold pl-0">{{ucfirst($stock['shortName'])}}</td>
                                        <td class="font-weight-bold" id="deposit-units">1</td>
                                        <td class="font-weight-bold">${{number_format($stock['regularMarketPrice'], 6)}}</td>
                                        <td class="font-weight-bold text-primary text-right pr-0" id="deposit-total">${{number_format($stock['regularMarketPrice'], 6)}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('input[name=units]').change(function () {
                ...
                var total = $(this).val() * {{$stock['regularMarketPrice']}};
