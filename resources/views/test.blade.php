...
<head>
    ...
    <title>Drag &amp; Drop - Arctic Admin Dashboard</title>
...
<div class="app-admin-wrap-layout-1 sidebar-full sidebar-theme-slate">
    <div class="sidebar-panel">
        ...
        <div class="brand"><img src="assets/images/arctic-admin-circle.svg" alt="" /><span class="app-logo-text ml-2 text-20">Arctic</span></div>
        <!-- Start:: user-->
                        ...
                        <ul class="metismenu show-on-load" id="ul-menu">
                            <li><a class="has-arrow" href="#"><i class="material-icons nav-icon">dashboard</i>Dashboards</a>
                                <ul class="mm-collapse">
                                    ...
                                    <li><a href="dashboards/dashboard.cryptoCurrency.html"><i class="bullet-icon"></i>Cryptocurrency</a></li>
                            ...
                            <li class="mm-active"><a class="has-arrow" href="#"><i class="material-icons nav-icon">web_asset</i>Pages</a>
                                <ul class="mm-collapse">
                                    ...
                                    <li class="mm-active"><a href="pages/dragAndDrop.html"><i class="material-icons nav-icon">open_with</i>Drag &amp; Drop</a></li>
    ...
    <div class="main-content-wrap">
            ...
            <div class="ul-header-topbar">
                ...
                <div class="dropdown language-dropdown mx-xx">
                    <div class="header-btn-group">
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="#"> <img class="avatar-xxs rounded-circle mr-sm" src="assets/images/flags/1x1/us.svg" alt="" />English</a><a class="dropdown-item" href="#"> <img class="avatar-xxs rounded-circle mr-sm" src="assets/images/flags/1x1/es.svg" alt="" />Spanish</a><a class="dropdown-item" href="#"> <img class="avatar-xxs rounded-circle mr-sm" src="assets/images/flags/1x1/in.svg" alt="" />Hindi</a></div>
                    </div>
                </div>
                ...
                <div class="dropdown profile-dropdown ml-xs">
                    <div class="header-btn-group">
                        <button class="btn d-flex py-1 pl-2 pr-0 rounded" id="dropdownTopUserProfile" type="button" data-sidebar-panel="asideProfile"><span class="m-0 mr-2 font-weight-normal">Hi, Watson</span><img class="avatar-sm rounded-circle mr-1" src="assets/images/faces/1.jpg" /></button>
                        <div aria-labelledby="dropdownTopUserProfile">
                            <div class="card dropdown-menu p-0 ul-avatar-dropdown">
                                <div class="card-header bg-primary">
                                    <div class="ul-avatar-dropdown-container"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/1.jpg" />
                                        <div class="content">
        ...
        <div class="main-content-body">
            ...
            <div class="container mt-lg">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="dragula" id="left-defaults">
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-flex justify-content-sm-between justify-content-center align-items-center flex-wrap"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/1.jpg" alt="" srcset="" />
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-flex justify-content-sm-between justify-content-center align-items-center flex-wrap"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/2.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1 text-sm-left text-center">
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-flex justify-content-sm-between justify-content-center align-items-center flex-wrap"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/3.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1 text-sm-left text-center">
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-flex justify-content-sm-between justify-content-center align-items-center flex-wrap"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/4.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1 text-sm-left text-center">
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-flex justify-content-sm-between justify-content-center align-items-center flex-wrap"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/5.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1 text-sm-left text-center">
                ...
                <div class="copy-code">
                    <button class="btn btn-sm btn-raised-primary btn-clipboard" data-toggle="tooltip" data-placement="top" title="Copy to clipboard">Copy</button>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="dragula" id="left-events">
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex text-sm-left text-center"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/1.jpg" alt="" srcset="" />
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex text-sm-left text-center"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/2.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">Unit Testing Engineer</h6>
                                                <p class="text-muted m-0">Jhon Doe</p>
                                            </div><i class="material-icons text-warning">grade </i>
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex text-sm-left text-center"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/3.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">UI/UX Designer</h6>
                                                <p class="text-muted m-0">Bloodhound</p>
                                            </div><i class="material-icons text-warning">grade </i>
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex text-sm-left text-center"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/4.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">Backend Developer</h6>
                                                <p class="text-muted m-0">Wraith</p>
                                            </div><i class="material-icons text-warning">grade </i>
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex text-sm-left text-center"><img class="avatar-md rounded-circle mr-2" src="assets/images/faces/5.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">Frontend Developer</h6>
                                                <p class="text-muted m-0">Phantom Jhon</p>
                                            </div><i class="material-icons text-warning">grade </i>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="dragula" id="left-remove">
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex align-items-center text-sm-left text-center"><img class="avatar-md rounded mr-2 mb-md" src="assets/images/faces/1.jpg" alt="" srcset="" />
                                            <div>
                                                <h6 class="mb-1">Richard McClintock, a Latin professor <a class="badge badge-primary" href="#">Status</a></h6>
                                                <p class="text-muted m-0">05 min ago</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex align-items-center text-sm-left text-center"><img class="avatar-md rounded mr-2 mb-md" src="assets/images/faces/2.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1">The standard chunk of Lorem Ipsum <a class="badge badge-primary" href="#">Status</a></h6>
                                                <p class="text-muted m-0">Jhon Doe</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="dragula" id="right-remove">
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex align-items-center text-sm-left text-center"><img class="avatar-md rounded mr-2 mb-md" src="assets/images/faces/1.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">All the Lorem Ipsum generators on the Internet <a class="badge badge-primary" href="#">Status</a></h6>
                                                <p class="text-muted m-0">Tim Clarkson</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex align-items-center text-sm-left text-center"><img class="avatar-md rounded mr-2 mb-md" src="assets/images/faces/5.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">The standard chunk of Lorem Ipsum <a class="badge badge-primary" href="#">Status</a></h6>
                                                <p class="text-muted m-0">Jhon Doe</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-sm-flex align-items-center text-sm-left text-center"><img class="avatar-md rounded mr-2 mb-md" src="assets/images/faces/4.jpg" alt="" srcset="" />
                                            <div class="flex-grow-1">
                                                <h6 class="m-0">Lorem Ipsum is not simply random text <a class="badge badge-primary" href="#">Status</a></h6>
                                                <p class="text-muted m-0">Bloodhound</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="dragula" id="left-feed">
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body">
                                            <div class="d-sm-flex text-sm-left text-center"><img class="avatar-md rounded mr-2" src="assets/images/faces/2.jpg" alt="" srcset="" />
                                                <div class="flex-1">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-6 col-sm-5 avatar-group m-0 text-sm-left text-center"><img class="avatar-sm rounded-circle" src="assets/images/faces/3.jpg" /><img class="avatar-sm rounded-circle" src="assets/images/faces/4.jpg" /><img class="avatar-sm rounded-circle" src="assets/images/faces/5.jpg" /></div>
                                                <div class="col-lg-6 col-sm-7 text-sm-right text-center"><span><a href="#">Tom Hiddle</a> and 12 other like this</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body">
                                            <div class="d-sm-flex text-sm-left text-center"><img class="avatar-md rounded mr-2" src="assets/images/faces/4.jpg" alt="" srcset="" />
                                                <div class="flex-1">
                                                    <h6 class="font-weight-normal mb-1">Jhon Doe</h6>
                                                    <p class="text-muted text-12">08 hours ago</p>
                                                </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="dragula" id="right-feed">
                                    ...
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body">
                                            <div class="d-sm-flex text-sm-left text-center"><img class="avatar-md rounded mr-2" src="assets/images/faces/5.jpg" alt="" srcset="" />
                                                <div class="flex-1">
                                                    <h6 class="font-weight-normal mb-1">Jhon Doe</h6>
                                                    <p class="text-muted text-12">08 hours ago</p>
                                                </div>
                                ...
                                <div class="dragula" id="left-handle">
                                    <div class="card mb-md cursor-pointer">
                                        <div class="card-body d-block d-xl-flex">
                                            <div class="avatar-group text-center text-sm-left mr-2"><img class="avatar-md rounded-circle" src="assets/images/faces/3.jpg" /><img class="avatar-md rounded-circle" src="assets/images/faces/4.jpg" /><img class="avatar-md rounded-circle" src="assets/images/faces/5.jpg" /></div>
                                            <div class="flex-1">
                                                <div class="d-sm-flex d-block justify-content-between text-sm-left text-center align-items-center">
                                                    <div>Head Of Dept</div>
                                                    <div><span class="badge badge-opacity badge-primary mx-auto"><i class="material-icons handle cursor-move">add</i></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="assets/js/pages/dragula.script.min.js"></script>
</body>
