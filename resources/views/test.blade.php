...
<head>
    ...
    <title>FAQ V1 - Arctic Admin Dashboard</title>
    <link href="https://fonts.googleapis.com/css?family=Material+Icons" rel="stylesheet" />
    <link href="https://fonts.googleapis.com/css2?family=Archivo:ital,wght@0,400;0,500;0,600;0,700;1,400&amp;display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" />
    <link rel="stylesheet" href="assets/css/vendors.bundle.min.css" />
    <link rel="stylesheet" type="text/css" href="assets/css/pages/faq/faq.v1.min.css" />
                        ...
                        <nav class="sidebar-nav">
                            <ul class="metismenu show-on-load" id="ul-menu">
                                ...
                                <li><a class="has-arrow" href="#"><i class="material-icons nav-icon">web_asset</i>Pages</a>
                                    <ul class="mm-collapse">
                                        <li class="mm-active"><a class="has-arrow" href="#"><i class="material-icons nav-icon">feedback</i>FAQ</a>
                                            <ul class="mm-collapse">
                                                <li class="mm-active"><a href="pages/faq/faq.v1.html"><i class="bullet-icon"></i>FAQ V1</a></li>
                ...
                <div class="subheader px-lg">
                    <div class="subheader-container">
                        <div class="subheader-main">
                            <h3 class="subheader-title">FAQ V1</h3>
                        ...
                        <div class="flex-grow-1"></div>
                        <button class="btn btn-sm btn-opacity btn-primary">Submit a Request</button>
                    </div>
                </div>
                <div class="container">
                        ...
                        <div class="col-md-12 py-xl mb-lg">
                            <div class="nav-pills-primary">
                                <ul class="nav nav-pills-card justify-content-center mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link m-sm active" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-home" aria-selected="true"><i class="material-icons icon text-33 mb-sm">home</i>
                                            <p class="font-weight-semi m-0">Getting started</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link m-sm" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-home" aria-selected="true"><i class="material-icons icon text-33 mb-sm">layers</i>
                                            <p class="font-weight-semi m-0">Plans & Pricing</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link m-sm" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-home" aria-selected="true"><i class="material-icons icon text-33 mb-sm">contact_support</i>
                                            <p class="font-weight-semi m-0">Sales Questions</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link m-sm" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-home" aria-selected="true"><i class="material-icons icon text-33 mb-sm">360</i>
